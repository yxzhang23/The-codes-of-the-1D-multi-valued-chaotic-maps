...
for i = 1 : 11
    switch i    
      ...
      %      plot(P2(1, :), P2(2, :), '.', 'color', [0.63 0.13 0.94 ]);hold on;  
        ...
        case 7
           plot(P6(1, :), P6(2, :), '.', 'color', [1 1 0]); hold on;  
        case 8
...
set(gca, 'position', [0.16 0.19 0.75 0.78], 'FontName', 'Times New Roman', 'FontSize', 24, 'XTick', -0.1:0.2:0.9, 'YTick', 0.2:0.3:1.4);
xlabel('\it a_R', 'FontSize', 28, 'FontName', 'Times new roman');
ylabel('\it a_I', 'FontSize', 28, 'FontName', 'Times new roman');
axis([-0.1 0.9 0.2 1.4]);
