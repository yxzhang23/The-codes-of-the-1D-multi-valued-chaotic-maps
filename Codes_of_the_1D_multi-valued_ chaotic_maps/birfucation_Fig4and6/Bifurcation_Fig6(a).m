...
% Iterate over 'c_R' values from 0.1 to 0.55 with a step size of 0.0008
for a = 0.1:0.0008:0.55
    % Set initial complex number
    x = 0.1 + 0.2i;
    
    % Iterate 10,000 times to reach a stable state
    for m = 1:10000
        x = (a + b * 1i) * complex_sqrt((x(1))^3, 3) - 1;
    end
...
set(gca, 'position', [0.11 0.29 0.87 0.68], 'FontName', 'Times New Roman', 'FontSize', 22, 'XTick', 0.1:0.1:0.6, 'YTick', -2.2:1.2:2.7);
xlabel('\it c_R', 'FontSize', 24, 'FontName', 'Times New Roman');
ylabel('\it x,y', 'FontSize', 24, 'FontName', 'Times New Roman');
axis([0.1 0.55 -2.3 2.7]);
