...
% the 1D-TWF across different initial conditions (x_0, y_0). The colormap 'hot' is used to represent
...
set(gca, 'xtick', [-2 0 2], 'FontName', 'Times New Roman', 'FontSize', 24);
set(gca, 'ytick', [-2 0 2], 'FontName', 'Times New Roman', 'FontSize', 24);
...
pos = get(h, 'Position');
set(h, 'Position', [pos(1) + 0.0 pos(2) pos(3)]);
