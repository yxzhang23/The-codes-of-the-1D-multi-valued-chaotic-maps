...
set(gca, 'xtick', [1.995 2 2.005], 'FontName', 'Times New Roman', 'FontSize', 24);
set(gca, 'xticklabel', {'1.995','2','2.005'});
set(gca, 'ytick', [-0.005 0  0.005], 'FontName', 'Times New Roman', 'FontSize', 24);
