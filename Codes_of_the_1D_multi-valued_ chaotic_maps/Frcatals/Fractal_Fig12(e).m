...
set(gca, 'xtick', [1.65 2.05 2.45], 'FontName', 'Times New Roman', 'FontSize', 24);
set(gca, 'ytick', [-0.4 0 0.4], 'FontName', 'Times New Roman', 'FontSize', 24);
set(gca, 'yticklabel', {' 0.4','0','-0.4'});
